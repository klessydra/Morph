...
set IP_PATH="${IPS_PATH}/klessydra-m"
...
echo "${Green}Compiling component: ${Brown} klessydra-m ${NC}"
echo "${Red}"
...
vcom -2008 -quiet -suppress 2583 -nowarn 5 -work ${LIB_PATH}   ${IP_PATH}/RTL-Program_Counter_unit.vhd || goto error
